                    ...
                    <div class="card card-details mb-3">
                        ...
                        <div class="attendee">
                            <table class="table table-responsive-sm text-center">
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">{{$detail->is_visa ? '30_DAYS' : 'N/A' }}</td>
                        ...
                        <div class="member mt-3">
                            ...
                            <form class="form-inline" method="post" action="{{route('checkout-create', $item->id)}}">
                                ...
                                <input type="text" class="form-control mb-2 mr-sm-2" id="nationality" name="nationality" placeholder="ID" style="width:50px;" required />
                        ...
                        <table class="trip-informations">
                            ...
                            <tr>
                                ...
                                <td width="50%" class="text-right text-total">
                                    <span class="text-blue">$ {{$item->transaction_total}},</span><span class="text-orange">{{mt_rand(0,00)}}</span>
                                </td>
                            </tr>
                        </table>
...
<script>
    $(document).ready(function() {
        $('.datepicker').datepicker({
            ...
            icons: {
                rightIcon: `<img src="/public/frontend/image/ic_doe@2x.png" alt="" />`
            }
        });
    });
</script>

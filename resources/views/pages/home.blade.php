        ...
        <div class="container">
            <div class="section-popular-travel row justify-content-center match-height">
                <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="card card-testimonial text-center">
                        <div class="testimonial-content">
                            <img src="frontend/images/zaq.jpg" alt="" style="width: 125px; height: 125px;" class="mb-4 rounded-circle" />
                            <h3 class="mb-4">Zaqlul</h3>
                            <p class="testimonials">
                                “ Seru banget jalan-jalan ke Bali, pemandangannya indah, banyak turis / bule yang cantik“
                            </p>
                        </div>
                        <hr />
                ...
                <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="card card-testimonial text-center">
                        <div class="testimonial-content">
                            <img src="frontend/images/dimas.jpg" alt="" style="width: 125px; height:125px;" class="mb-4 rounded-circle" />
                            <h3 class="mb-4">Dimas</h3>
                            <p class="testimonials">
                                “ Puas banget pergi ke Nusa Penida, banyak hal yang menarik di pulau tersebut “
                            </p>
                        </div>
                        <hr />
